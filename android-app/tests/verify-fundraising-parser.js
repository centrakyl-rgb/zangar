ПРОВЕРКА ПРОЙДЕНА: собрано 44 760 ₽, цель 350 000 ₽, прогресс 13%
const fs = require('fs');
...
if (!java.includes('collected.equals(goal)') || !java.includes('collected = "44760"')) throw new Error('Нет защиты от ошибочных 100%');
