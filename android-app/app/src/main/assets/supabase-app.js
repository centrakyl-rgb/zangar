(function(){
  ...
  async function addSchedulePanel(canEdit,onlyMine){
    ...
    var rows=await api(query),days=["","Понедельник","Вторник","Среда","Четверг","Пятница","Суббота"],periods=[{n:1,start:"08:00",end:"08:45"},{n:2,start:"08:55",end:"09:40"},{n:3,start:"09:50",end:"10:35"},{n:4,start:"10:45",end:"11:30"},{n:5,start:"11:40",end:"12:25"},{n:6,start:"12:35",end:"13:20"},{n:7,start:"13:30",end:"14:15"},{n:8,start:"14:25",end:"15:10"}];
